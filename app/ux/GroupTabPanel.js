...
Ext.define('Ext.ux.GroupTabPanel', {
    ...
    initComponent: function (config) {
        ...
        me.addEvents(
             ...
             * Fires before a tab change (activated by {@link #setActiveTab}).
             * Return false in any listener to cancel
             * the tabchange
             ...
             * Fires before a group change (activated by {@link #setActiveGroup}).
             * Return false in any listener to cancel
             * the groupchange
             * @param {Ext.ux.GroupTabPanel} grouptabPanel The GroupTabPanel
    ...
    setActiveTab: function (cmp) {
        ...
        if (me.fireEvent('beforetabchange', me, newTab, oldTab) !== false) {
            me.activeTab = newTab;
            if (me.rendered) {
                me.down('container[baseCls=' + Ext.baseCSSPrefix + 'grouptabcontainer' + ']')
                    .getLayout().setActiveItem(newTab);
            }
    ...
    createTreeStore: function () {
        ...
        Ext.each(groups, function (groupItem, idx) {
            ...
            Ext.each(leafItems, function (leafItem) {
                ...
                leafItem.border = /*leafItem.border || */false;
                cards.push(leafItem);
            });
