 ...
 * supporting the standard {@link Ext.toolbar.Toolbar}
 * interface for adding buttons, menus and other items, the StatusBar
 * provides a greedy status element that can be aligned to either
 * side and has convenient methods for setting the
 * status text and icon.  You can also indicate that
 * something is processing using the {@link #showBusy} method.
 *
...
Ext.define('Ext.ux.statusbar.StatusBar', {
     ...
     * The alignment of the status element within the overall StatusBar layout.
     * When the StatusBar is rendered,
     * it creates an internal div containing the status text and icon.
     * Any additional Toolbar items added in the
     * StatusBar's {@link #cfg-items} config, or added via {@link #method-add}
     * or any of the supported add* methods, will be
     ...
     * The default {@link #iconCls} value (see the iconCls docs for
     * additional details about customizing the icon).
     ...
     * {@link #defaultText} and {@link #defaultIconCls} via a fade out animation.
     * If a numeric value is passed,
    ...
    /**
     * Clears the status {@link #text} and {@link #iconCls}.
     * Also supports clearing via an optional fade out animation.
     *
     ...
     * {@link #defaultIconCls} (defaults to false which sets the text to ''
     * and removes any existing icon class).
     *
     * @return {Ext.ux.statusbar.StatusBar} this
     */
    ...
    /**
     * Convenience method for setting the status text directly.
     * For more flexible options see {@link #setStatus}.
    ...
    /**
     * Convenience method for setting the status icon directly.
     * For more flexible options see {@link #setStatus}.
     * See {@link #iconCls} for complete details about customizing the icon.
     * @param {String} iconCls (optional) The icon class to set (defaults to '',
     * and any current icon class is removed)
     * @return {Ext.ux.statusbar.StatusBar} this
     */
    ...
    /**
     * Convenience method for setting the status text and icon
     * to special values that are pre-configured to indicate
     * a "busy" state, usually for loading or processing activities.
     *
     * @param {Object/String} config (optional)
     *      A config object in the same format supported by {@link #setStatus},
     * or a * string to use as the status text
     *      (in which case all other options for setStatus will be defaulted).
     * Use the
     * `text` and/or `iconCls` properties on the config to override the default {@link #busyText}
     * and {@link #busyIconCls} settings. If the config argument is not specified, {@link #busyText} and
     * {@link #busyIconCls} will be used in conjunction
     *      with all of the default options for {@link #setStatus}.
     * @return {Ext.ux.statusbar.StatusBar} this
     */
    showBusy: function (o) {
        if (Ext.isString(o)) {
