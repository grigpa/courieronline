...
Ext.Loader.addClassPathMappings({
  "COURIERONLINE": "../../app",
  "COURIERONLINE.locale.EDSService": "../../app/locale/ru.js",
  "COURIERONLINE.locale.MessageBox": "../../app/locale/ru.js",
  "COURIERONLINE.locale.statusbar.StatusBar": "../../app/locale/ru.js",
  "COURIERONLINE.locale.statusbar.ValidationStatus": "../../app/locale/ru.js",
  "Ext": "../../ext/src",
...
Ext.ClassManager.addNameAlternateMappings({
  "COURIERONLINE.Application": [],
  "COURIERONLINE.Startup": [],
  "COURIERONLINE.controller.Base": [],
  "COURIERONLINE.controller.DocWorkflow": [],
  "COURIERONLINE.controller.Docflows": [],
  "COURIERONLINE.controller.Documents": [],
  "COURIERONLINE.controller.Header": [],
  "COURIERONLINE.controller.Inspections": [],
  "COURIERONLINE.controller.Keys": [],
  "COURIERONLINE.controller.Login": [],
  "COURIERONLINE.controller.Main": [],
  "COURIERONLINE.controller.News": [],
  "COURIERONLINE.controller.Operators": [],
  "COURIERONLINE.controller.Organizations": [],
  "COURIERONLINE.controller.ProfileInfo": [],
  "COURIERONLINE.controller.SendWin": [],
  "COURIERONLINE.controller.SuperInspections": [],
  "COURIERONLINE.controller.Tasks": [],
  "COURIERONLINE.controller.Templates": [],
  "COURIERONLINE.locale.EDSService": [],
  "COURIERONLINE.locale.MessageBox": [],
  "COURIERONLINE.locale.ru": [],
  "COURIERONLINE.locale.statusbar.StatusBar": [],
  "COURIERONLINE.locale.statusbar.ValidationStatus": [],
  "COURIERONLINE.model.AppInfo": [],
  "COURIERONLINE.model.ClientInfo": [],
  "COURIERONLINE.model.DocWorkflow": [],
  "COURIERONLINE.model.DocWorkflowAttach": [],
  "COURIERONLINE.model.DocWorkflowCert": [],
  "COURIERONLINE.model.DocWorkflowPacket": [],
  "COURIERONLINE.model.Docflow": [],
  "COURIERONLINE.model.Document": [],
  "COURIERONLINE.model.Inspection": [],
  "COURIERONLINE.model.News": [],
  "COURIERONLINE.model.Operator": [],
  "COURIERONLINE.model.OperatorInfo": [],
  "COURIERONLINE.model.Organization": [],
  "COURIERONLINE.model.PostServerInfo": [],
  "COURIERONLINE.model.Profile": [],
  "COURIERONLINE.model.SuperInspection": [],
  "COURIERONLINE.model.Task": [],
  "COURIERONLINE.model.Template": [],
  ...
  "COURIERONLINE.overrides.form.Basic": [],
  "COURIERONLINE.overrides.form.Panel": [],
  "COURIERONLINE.overrides.form.field.Base": [],
  "COURIERONLINE.overrides.form.field.File": [],
  "COURIERONLINE.services.EDSService": [],
  "COURIERONLINE.services.SignAndSend": [],
  "COURIERONLINE.store.DocWorkflow": [],
  "COURIERONLINE.store.Docflows": [],
  "COURIERONLINE.store.Documents": [],
  "COURIERONLINE.store.Inspections": [],
  "COURIERONLINE.store.InspectionsPFR": [],
  "COURIERONLINE.store.Navigator": [],
  "COURIERONLINE.store.News": [],
  "COURIERONLINE.store.Notice": [],
  "COURIERONLINE.store.Operators": [],
  "COURIERONLINE.store.Organizations": [],
  "COURIERONLINE.store.SuperInspections": [],
  "COURIERONLINE.store.Tasks": [],
  "COURIERONLINE.store.Templates": [],
  "COURIERONLINE.store.Togs": [],
  "COURIERONLINE.view.CertWin": [],
  "COURIERONLINE.view.Docflow.Grid": [],
  "COURIERONLINE.view.Document.DocWorkflowList": [],
  "COURIERONLINE.view.Document.DocWorkflowRoot": [],
  "COURIERONLINE.view.Document.DraftsGrid": [],
  "COURIERONLINE.view.Document.Grid": [],
  "COURIERONLINE.view.Document.OutboxGrid": [],
  "COURIERONLINE.view.Document.Win": [],
  "COURIERONLINE.view.Document.WinDraft": [],
  "COURIERONLINE.view.Document.WinLetter": [],
  "COURIERONLINE.view.Filter": [],
  "COURIERONLINE.view.Footer": [],
  "COURIERONLINE.view.Header": [],
  "COURIERONLINE.view.Inspection.AddWin": [],
  "COURIERONLINE.view.Inspection.Form": [],
  "COURIERONLINE.view.Inspection.Grid": [],
  "COURIERONLINE.view.Inspection.TogsForm": [],
  "COURIERONLINE.view.Inspection.Win": [],
  "COURIERONLINE.view.Key.Form": [],
  "COURIERONLINE.view.Key.Grid": [],
  "COURIERONLINE.view.Key.Win": [],
  "COURIERONLINE.view.Login": [],
  "COURIERONLINE.view.LoginViewport": [],
  ...
  "COURIERONLINE.view.Operator.Form": [],
  "COURIERONLINE.view.Operator.Grid": [],
  "COURIERONLINE.view.Operator.Win": [],
  "COURIERONLINE.view.Organization.Form": [],
  "COURIERONLINE.view.Organization.Grid": [],
  "COURIERONLINE.view.Organization.Win": [],
  ...
  "COURIERONLINE.view.ProfileInfo.ClientForm": [],
  "COURIERONLINE.view.ProfileInfo.OperatorForm": [],
  "COURIERONLINE.view.ProfileInfo.Win": [],
  "COURIERONLINE.view.SendWin": [],
  "COURIERONLINE.view.SuperInspection.Form": [],
  "COURIERONLINE.view.SuperInspection.Grid": [],
  "COURIERONLINE.view.SuperInspection.Win": [],
  "COURIERONLINE.view.Task.Grid": [],
  "COURIERONLINE.view.Templates.Grid": [],
  "COURIERONLINE.view.Viewport": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "COURIERONLINE.view.Document.DocWorkflowList": [
    "widget.docWorkflowList"
  ],
  "COURIERONLINE.view.Document.DocWorkflowRoot": [
    "widget.docWorkflowRoot"
  ],
  "COURIERONLINE.view.Document.DraftsGrid": [
    "widget.documentDraftsGrid"
  ],
  "COURIERONLINE.view.Document.Grid": [
    "widget.documentGrid"
  ],
  "COURIERONLINE.view.Document.OutboxGrid": [
    "widget.documentGridOutbox"
  ],
  "COURIERONLINE.view.Document.Win": [
    "widget.documentWin"
  ],
  "COURIERONLINE.view.Document.WinDraft": [
    "widget.documentWinDraft"
  ],
  "COURIERONLINE.view.Document.WinLetter": [
    "widget.documentWinLetter"
  ],
  "COURIERONLINE.view.Filter": [
    "widget.appFilter"
  ],
  ...
  "COURIERONLINE.view.Inspection.AddWin": [
    "widget.inspectionAddWin"
  ],
  "COURIERONLINE.view.Inspection.Form": [
    "widget.inspectionForm"
  ],
  "COURIERONLINE.view.Inspection.Grid": [
    "widget.inspectionGrid"
  ],
  "COURIERONLINE.view.Inspection.TogsForm": [
    "widget.togsForm"
  ],
  "COURIERONLINE.view.Inspection.Win": [
    "widget.inspectionWin"
  ],
  "COURIERONLINE.view.Key.Form": [
    "widget.keyForm"
  ],
  ...
  "COURIERONLINE.view.Organization.Grid": [
    "widget.organizationGrid"
  ],
  "COURIERONLINE.view.Organization.Win": [
    "widget.organizationWin"
  ],
  "COURIERONLINE.view.ProfileInfo.AppInfoForm": [
    "widget.appInfoForm"
  ],
  ...
  "COURIERONLINE.view.ProfileInfo.ChangePasswordWin": [
    "widget.changePasswordWin"
  ],
  "COURIERONLINE.view.ProfileInfo.ClientForm": [
    "widget.clientInfoForm"
  ],
  "COURIERONLINE.view.ProfileInfo.OperatorForm": [
    "widget.operatorInfoForm"
  ],
  "COURIERONLINE.view.ProfileInfo.Win": [
    "widget.operatorInfoWin"
  ],
  "COURIERONLINE.view.SendWin": [
    "widget.sendWin"
  ],
  "COURIERONLINE.view.SuperInspection.Form": [
    "widget.superInspectionForm"
  ],
  "COURIERONLINE.view.SuperInspection.Grid": [
    "widget.superInspectionGrid"
  ],
  "COURIERONLINE.view.SuperInspection.Win": [
    "widget.superInspectionWin"
  ],
  "COURIERONLINE.view.Task.Grid": [
    "widget.taskGrid"
  ],
...
Ext.setVersion("courier-online-theme", "1.0.0");
